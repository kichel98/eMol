...
INSERT INTO book (isbn, title, subtitle, description, author, price, publisher_id, date, language_id, type)
 ...
 "This is the book that will change your life", "Joe Doe", 14.99, 2, "2018/10/8", 1, "ebook");
 ...
 VALUES("9999999999", "Keto Diet", "How to lose 5 pounds in two weeks", 
 "This is the book that will change your life", "Joe Doe", 14.99, 2, "2018/10/8", 1, "ebook");
 INSERT INTO ebook (book_id, pages, file_size) VALUES(5, 120, 4);
 
 INSERT INTO book (isbn, title, subtitle, description, author, price, publisher_id, date, language_id, type)
 VALUES("9999999998", "Yoga For Beginners", "Relaxe Your Body With This 5 Step Program", 
 "This is the only book you need", "Sarah Harrison", 11.99, 2, "2018/12/30", 1, "paperback");
  INSERT INTO paperback (book_id, pages) VALUES(6, 250);
